...
<h1>Expense</h1>
    ...
    <div class="row">
		...
		<!--<td><%=sb.getDeleted()%></td>-->
		<td>
		<a href="editexpenseuser?expenseId=<%=sb.getExpenseId()%>" style="color:blue;"><i class="bi bi-pencil-square" style="font-size:20px;"></i></a> 
		...
		<a href="viewexpenseuser?expenseId=<%=sb.getExpenseId()%>" style="color:black;"><i class="bi bi-eye" style="font-size:20px;"></i></a></td>
		</tr>
	    <%} %>
                  </tbody>
              </table>
