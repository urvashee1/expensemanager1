            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="sendotpforforgetpassword" method="post" id="myform">
                    <div class="col-12">
                   ...
                   <!-- </div>-->
                    ...
                    <div class="col-12">
                      <input type="button" class="btn btn-primary w-100" value="Send Otp" onclick="validation()"/>
                    </div>
